...
const Flight = () => {
  ...
  return (
    <View>
      {image &&  <Image
            source={{ uri: 'https://icons.veryicon.com/png/o/miscellaneous/official-icon-of-flying-pig/flashlight-on.png' }}
            style={{ width: 100, height: 150, resizeMode: "stretch" , marginVertical: 20}}
          />
          }
        {!image &&  <Image
            source={{ uri: 'https://icons.veryicon.com/png/o/miscellaneous/official-icon-of-flying-pig/flashlight-off-2.png' }}
            style={{ width: 100, height: 150, resizeMode: "stretch" ,  marginVertical: 20}}
          />
          }
